...
const BuildingUnitsTable: FC<BuildingUnitsTableProps> = ({ cryptoOrders }) => {
...
BuildingUnitsTable.propTypes = {
  cryptoOrders: PropTypes.array.isRequired
};

BuildingUnitsTable.defaultProps = {
  cryptoOrders: []
};

export default BuildingUnitsTable;
