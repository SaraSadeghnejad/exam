          ...
          >
            ...
            <Grid
              ...
              <div className='flex justify-between'>
                <div className='flex flex-col justify-between mt-1 mr-2'>
                ...
                <Grid item  sm={6}
                alignItems="between"
              lg={6} direction="column">
            
              <div sx={{textAlign: "center", color: "#595959"}} fontSize="15px" className='flex justify-between mt-2 dark:text-slate-100 text-slate-900'>
                  <span sx={{textAlign: "center"}} fontSize="15px" fontWeight="bold" className='dark:text-slate-100 text-slate-900'>
                45
              </span> 
              تعداد کل شارژهای من
              ...
              <div sx={{textAlign: "center", color: "##595959",marginTop: "15px"}} fontSize="15px" className='flex justify-between mt-2 dark:text-slate-100 text-slate-900'>
                 <span sx={{textAlign: "center"}} fontSize="15px" fontWeight="bold" className='dark:text-slate-100 text-slate-900'>
              ۱۹،۰۰۰،۰۰۰ تومان
              </span>
              مبلغ کل شارژهای من
