     ...
     <Avatar variant="rounded" alt={user.name} src={user.avatar} className="mx-2" sx={{borderRadius:"50%"}}  />
        ...
        <Hidden mdDown>
          <UserBoxText>
            ...
            <UserBoxDescription variant="body2"  className={`${
      ...
      >
        <MenuUserBox sx={{ minWidth: 210 }} display="flex">
          <Avatar variant="rounded" alt={user.name} src={user.avatar} className="mx-2"/>
          <UserBoxText>
            <UserBoxLabel variant="body1">{user.name}</UserBoxLabel>
            <UserBoxDescription variant="body2" className={`${
                  router.locale === 'fa' ? 'rtl-text-right' : 'ltr-text-left'
        ...
        <List sx={{ p: 1 }} component="nav" >
          <NextLink href="/management/profile" passHref>
            <ListItem button>
              ...
              <ListItemText primary={t('header.My Profile')}  
                className={`${router.locale === 'fa' ? 
                'rtl-text-right' :
                'ltr-text-left'}`} />
            </ListItem>
          </NextLink>
